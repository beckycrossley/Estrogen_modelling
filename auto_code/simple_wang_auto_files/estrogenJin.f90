...
subroutine FUNC(ndim, u, icp, par, ijac, f, dfdu, dfdp)
	...
	DOUBLE PRECISION :: Jin, Jpmca, Jserca,Jipr, Jryr, Jleak , e_eff
	
	!ESTROGEN PArameters
    DOUBLE PRECISION ::E = 0.1
    DOUBLE PRECISION :: k_e1 = 0.01
    DOUBLE PRECISION :: k_e2 =  0.2 
    DOUBLE PRECISION :: k_e_in = 0.9 
    DOUBLE PRECISION :: h = 4 
    DOUBLE PRECISION :: EC50 = 2000

    ! Extract the state variables and continuation parameters
    DOUBLE PRECISION Ca_in, Ca_sr, y ! State variables
	...
	e_eff = (1.0-k_e_in*E)
    Jin = a_0-a_1*I_Ca/(2*Faraday)*e_eff +a_2*P
...
subroutine STPNT(ndim, u, par, t)
    ...
    u(1) = 0.158803 ! Cin SS Value
    u(2) = 27.33752353 ! C_SR SS value
	u(3) = 0.5227182 !y SS value
